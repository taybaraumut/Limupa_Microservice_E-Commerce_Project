...
{
    public class ProductSmartWatchListController : Controller
    {
        [HttpGet]
        public IActionResult Index(List<string> productName, List<string> productPrice, List<string> productColor)
        {
            ...
            return View(new { productName = TempData["productName"], productPrice = TempData["productPrice"], productColor = TempData["productColor"] });
        }
    }
}
