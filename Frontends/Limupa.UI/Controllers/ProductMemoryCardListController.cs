...
{
    public class ProductMemoryCardListController : Controller
    {
        [HttpGet]
        public IActionResult Index(List<string> productName, List<string> productPrice, List<string> productModel, List<string> productStorage)
        {
            ...
            TempData["productStorage"] = productStorage;

            return View(new { productName = TempData["productName"], productPrice = TempData["productPrice"], productModel = TempData["productModel"], productStorage = TempData["productStorage"] });
        }
    }
}
