...
{
    public class ProductBluetoothListController : Controller
    {
        [HttpGet]
        public IActionResult Index(List<string> productName, List<string> productPrice,List<string> productModel)
        {
            ...
            return View(new { productName = TempData["productName"], productPrice = TempData["productPrice"], productModel = TempData["productModel"] });            
        }       
    }
}
