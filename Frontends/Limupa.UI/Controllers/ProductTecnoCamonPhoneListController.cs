...
{
    public class ProductTecnoCamonPhoneListController : Controller
    {
        [HttpGet]
        public IActionResult Index(List<string> productName, List<string> productPrice, List<string> productModel, List<string> productInternalMemorySize, List<string> productMobileRamSize)
        {
            ...
            TempData["productMobileRamSize"] = productMobileRamSize;
            ...
            return View(
                new
                {
                    ...
                    productMobileRamSize = TempData["productMobileRamSize"]
                });
        }
    }
}
