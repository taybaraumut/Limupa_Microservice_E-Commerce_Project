...
{
    public class ProductDesktopComputerGridListComponentPartial:ViewComponent
    {
        private readonly IProductService productService;

        public ProductDesktopComputerGridListComponentPartial(IProductService productService)
        {
