...
{
    public class ProductLaptopComputerGridListComponentPartial:ViewComponent
    {
        private readonly IProductService productService;

        public ProductLaptopComputerGridListComponentPartial(IProductService productService)
        {
